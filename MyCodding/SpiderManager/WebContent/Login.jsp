...
<div class="login_div">
	...
	<form action="/SpiderManager/LoginServlet" class="login" method="post">
		<div class="nav">
			<div class="nav login_nav">
				...
				<div class="col-xs-6 login_usernameInput">
					<input type="text" name="yonghuming" id="name" value="" placeholder="&nbsp;&nbsp;用户名"  onblur="javascript:ok_or_errorBylogin(this)" />
				</div>
			...
			<div class="nav login_psdNav">
				...
				<div class="col-xs-6">
					<input type="password" name="mima" id="psd" value="" placeholder="&nbsp;&nbsp;密码" onBlur="javascript:ok_or_errorBylogin(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
...
<div class="register_body">
	...
	<form action="/Scrapy/RegistServlet" class="register" method="post">
		<div class="nav">
			<div class="nav register_nav">
				...
				<div class="col-xs-6">
					<input type="text" name="yonghuming" id="name_r" value="" placeholder="&nbsp;&nbsp;用户名/手机号" onBlur="javascript:ok_or_errorByRegister(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
			...
			<div class="nav register_psdnav">
				...
				<div class="col-xs-6">
					<input type="password" name="mima" id="psd_r" value="" placeholder="&nbsp;&nbsp;密码" onBlur="javascript:ok_or_errorByRegister(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
			...
			<div class="nav register_affirm">
				...
				<div class="col-xs-6">
					<input type="password" name="querenmima" id="affirm_psd" value="" placeholder="&nbsp;&nbsp;确认密码" onBlur="javascript:ok_or_errorByRegister(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
